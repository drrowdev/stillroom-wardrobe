...
export const AZURE_MANIFEST = 'azure-eu-terra-devtest-v1';
  ...
  properties: {
    ...
    fields: { type: 'object', additionalProperties: false,
      ...
      properties: {
        ...
        colours: { type: 'array', items: { type: 'string', enum: ['black', 'white', 'grey', 'navy', 'blue', 'green', 'olive', 'beige', 'brown', 'red', 'yellow', 'orange', 'pink', 'purple'] } },
...
export const AZURE_SETTINGS = {"profileId":"azure-eu-terra-devtest-v1","purpose":"inactive-dev-test","product":"Azure OpenAI","deploymentType":"DataZoneStandard","region":"EU","api":"v1/chat/completions","endpoint":"https://stillroom-ai-eval.openai.azure.com/openai/v1/chat/completions","expectedSnapshot":"gpt-5.6-terra-2026-07-09","acceptedReturnedModels":{"expected_snapshot":"gpt-5.6-terra-2026-07-09","model_family":"gpt-5.6-terra","deployment_alias":"eval-terra-20260709"},"schemaVersion":1,"promptVersion":1,"noticeRevision":2,"reviewExpiresAt":"2026-10-21T00:00:00Z","bodyControls":{"model":"eval-terra-20260709","n":1,"stream":false,"reasoning_effort":"low","max_completion_tokens":2048,"store":false,"prompt_cache_options":{"mode":"explicit"}},"messages":[{"role":"system","contentSource":"az1-candidate-prompt.txt"},{"role":"user","content":[{"type":"image_url","image_url":{"urlSource":"prepared-main-jpeg-inline-data-uri","detail":"high"}}]}],"responseFormat":{"type":"json_schema","json_schema":{"name":"garment_facts","strict":true,"schemaSource":"az1-candidate-schema.json"}},"limits":{"imageBytes":512000,"imageMaxSide":1600,"responseBytes":262144,"resultBytes":8192,"requestMs":20000,"inputTokens":922000,"outputTokens":2048},"metering":{"requiredCounters":["usage.prompt_tokens","usage.completion_tokens","usage.total_tokens","usage.completion_tokens_details.reasoning_tokens","usage.prompt_tokens_details.cached_tokens","usage.prompt_tokens_details.cache_write_tokens"],"unconsumedExtensions":"ignore-without-persistence","cacheReadRequired":0,"cacheWriteRequired":0,"currency":"USD","inputRateHundredthsPerMillion":440,"outputRateHundredthsPerMillion":1980,"reservationMicro":"4097351","rounding":"sum-token-rate-products-then-ceiling-divide-by-100"},"automaticRetries":0,"fallback":false};
