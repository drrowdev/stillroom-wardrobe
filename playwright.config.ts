...
export default defineConfig({
  ...
  projects: [
    ...
    {
      name: 'webkit-photo',
      testMatch: ['image-processing.spec.ts', 'slice.spec.ts', 'profile.spec.ts', 'images.spec.ts', 'item-details.spec.ts', 'garment-fields.spec.ts', 'ai-photo-first.spec.ts', 'items.spec.ts'],
