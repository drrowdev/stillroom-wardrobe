  ...
  test(`different-account tabs retain their owner when ${firstOwner} signs in first, and logout clears both`, async ({ page, context }, testInfo) => {
    ...
    for (const backend of Object.values(backends)) {
      for (const owner of ['a', 'b'] as const) {
        ...
        backend.items.push({ id: itemId, owner_id: owners[owner], title: content[owner].title, category: owner === 'a' ? 'top' : 'bottom', created_at: '2026-09-06T00:00:00Z', deleted_at: null, favourite: false, availability: 'ready', lifecycle: 'active', exclude_suggestions: false, brand: null, tags: [], colours: [], seasons: [], formality: null, purchase_price: null, currency: 'EUR',
          warmth: null, lower_coverage: null, min_temp: null, max_temp: null, rain_rating: null, windproof: null, field_provenance: {} });
