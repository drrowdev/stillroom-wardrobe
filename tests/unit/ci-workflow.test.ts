...
describe('CI workflow browser split', () => {
  ...
  it('uploads each of the 12 browser artifacts exactly once, from the App job, success-only and exact-head named', () => {
    const app = job('app');
    ...
    expect(count(workflow, upload)).toBe(13);
