...
Historical I06 ran on PR #7, `copilot/copilotphase1-personal-settings`, from
...
Its original 22 paths plus the App artifact step were that packet's scope, not
a future task's allowlist. I06 merged as `6caf1b0b3dde369d85941688c7c32d5664ffce0b`;
...
Those are historical approvals; the completed I06 plan/amendment record actual
Anthropic Claude Opus 5 `personal-settings-plan-critique` and
`i06-visual-transport-critique`, their findings and coordinator corrections.
Each new packet uses its own reviewed plan; routine corrections within that
