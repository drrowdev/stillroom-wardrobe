...
| 3 — outfits/history | I11–I13 | Phase 2 green; atomic outfit/calendar operations, DST/date cases and cost-per-wear arithmetic pass. 24 Sep 2026 (PR #37 comment 5815445262): I12/I13 calendar are in the backlog by owner decision; the calendar, DST/date and cost-per-wear exit checks are deferred, not passed; Phase 4 must not require wear history. | Lost links or double counts. Use RPC transactions and historical snapshots; revert UI without deleting history. |
